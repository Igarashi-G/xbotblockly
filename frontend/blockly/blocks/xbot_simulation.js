...
goog.provide('Blockly.Blocks.xbot_simulation');//xbot
...
Blockly.Blocks['xbot_move'] = {
  init: function() {
	...
	.appendField(new Blockly.FieldDropdown([["Forward", "forward"], ["Backward", "backward"]]), "direction")
        .appendField("at")
	.appendField(new Blockly.FieldTextInput("25"), "MOVE_SPEED")
	.appendField("cm/s");;
    this.setNextStatement(true, null);
    this.setPreviousStatement(true, null);
    this.setColour(255);
...
Blockly.Blocks['xbot_move_time'] = {
  init: function() {
    this.appendDummyInput()
        .appendField('Move ')
        .appendField(new Blockly.FieldDropdown([["Forward", "forward"], ["Backward", "backward"]]), "direction")
	.appendField(new Blockly.FieldTextInput("3"), "MOVE_SECS")
        .appendField("seconds at")
	.appendField(new Blockly.FieldTextInput("20"), "MOVE_SPEED")
	.appendField("cm/s");
    this.setNextStatement(true, null);
    this.setPreviousStatement(true, null);
    this.setColour(255);
...
Blockly.Blocks['xbot_circle'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Move ")
        .appendField(new Blockly.FieldDropdown([["Clockwise","clockwise"],["Anti-clockwise","anti-clockwise"]]),"clock")
        .appendField(new Blockly.FieldDropdown([["Left", "left"], ["Right", "right"]]), "direction")   
        .appendField(new Blockly.FieldTextInput("20"), "MOVE_SPEED")
        .appendField("cm/s")
	.appendField(new Blockly.FieldTextInput("20"), "TURN_SPEED")
    ...
    this.setPreviousStatement(true, null);
    this.setColour(255);
    this.setTooltip('move like circle xbot at speed');
    this.setHelpUrl('www.iscas.ac.cn');
  }
};
