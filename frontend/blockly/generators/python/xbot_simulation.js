...
goog.provide('Blockly.Python.xbot_simulation');//xbot
...
Blockly.Python['xbot_start'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_bringup.py");
  return code;  
};
...
Blockly.Python['xbot_stop'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_stop.py");
  return code;  
};
...
Blockly.Python['xbot_end'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_shutdown.py");
  return code;  
};
...
Blockly.Python['xbot_move'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_move.py")
  return code;
};
...
Blockly.Python['xbot_turn'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_turn.py");
  return code;
};
...
Blockly.Python['xbot_move_time'] = function(block) {
  ...
  var code = "";
  code += "dropdown_direction = \"" + dropdown_direction.toString() + "\"\n";
  code += "set_time = \"" + seconds.toString() + "\"\n";
  code += "move_speed = \"" + move_speed.toString() + "\"\n";
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_move_time.py");
...
Blockly.Python['xbot_move_dist'] = function(block) {
  ...
  code += "move_speed = \"" + move_speed.toString() + "\"\n";
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_move_dist.py");
  return code;
};
...
Blockly.Python['xbot_turn_angle'] = function(block) {
  ...
  code += "turn_speed = \"" + turn_speed.toString() + "\"\n";
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_turn_angle.py");
  return code;
};
...
Blockly.Python['xbot_turn_time'] = function(block) {
  ...
  code += "turn_speed = \"" + turn_speed.toString() + "\"\n";
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_turn_time.py");
  return code;
};


Blockly.Python['xbot_circle'] = function(block) {
  var clock_direction = block.getFieldValue('clock');
  var direction = block.getFieldValue('direction');
  var move_speed = block.getFieldValue('MOVE_SPEED');
  var turn_speed = block.getFieldValue('TURN_SPEED');
  var code = "";
  code += "clock_direction = \"" + clock_direction.toString() + "\"\n";
  code += "direction = \"" + direction.toString() + "\"\n";
  code += "move_speed = \"" + move_speed.toString() + "\"\n";
  code += "turn_speed = \"" + turn_speed.toString() + "\"\n";
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_circle.py");
  return code;
};
...
Blockly.Python['xbot_rplidar'] = function(block) {
  ...
  code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/xbot_rplidar.py");
  return code;  
};
...
Blockly.Python['xbot_get_laser'] = function(block) {
    ...
    var code = "";
    code += Blockly.readPythonFile("../blockly/generators/python/scripts/xbot_simulation/get_laser.py");
